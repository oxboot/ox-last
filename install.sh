...
function ox_install()
{
  ox_lib_echo "Install pre dependencies(Git, Curl, Gzip & Tar), please wait..."
  apt-get -y install git curl gzip tar || ee_lib_error "Unable to install pre dependencies, exit status " 1

  ox_lib_echo "Install PHP 7.2, please wait..."
  add-apt-repository -y 'ppa:ondrej/php'
  apt-get update &>> /dev/null
  apt-get -y install php7.2-fpm php7.2-curl php7.2-gd php7.2-imap php7.2-readline php7.2-common php7.2-recode php7.2-mysql php7.2-cli php7.2-curl php7.2-mbstring php7.2-bcmath php7.2-mysql php7.2-opcache php7.2-zip php7.2-xml php-memcached php-imagick php-memcache memcached graphviz php-pear php-xdebug php-msgpack php7.2-soap || ox_lib_echo_fail "Unable to install PHP 7.2, exit status " 1
